{
  BASSWMA 2.4 Delphi/Pascal unit
...
const
  ...
  // Additional filetype
  BASS_FILE_ISTREAM          = 2; // IStream object
...
function BASS_WMA_StreamCreateFile(filetype:DWORD; fl:pointer; offset,length:QWORD; flags:DWORD): HSTREAM; stdcall; external basswmadll;
function BASS_WMA_StreamCreateFileAuth(filetype:DWORD; fl:pointer; offset,length:QWORD; flags:DWORD; user,pass:PChar): HSTREAM; stdcall; external basswmadll;
