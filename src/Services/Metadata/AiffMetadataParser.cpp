...
bool AiffMetadataParser::Parse(const std::string& filePath, MusicTrack& track) const
{
...
std::vector<uint8_t> AiffMetadataParser::ReadFileBytes(const std::string& filePath) const
{
