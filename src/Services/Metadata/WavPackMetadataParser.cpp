...
bool WavPackMetadataParser::Parse(const std::string& filePath, MusicTrack& track) const
{
...
std::vector<uint8_t> WavPackMetadataParser::ReadFileBytes(const std::string& filePath) const
{
