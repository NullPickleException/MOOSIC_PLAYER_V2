...
namespace moosic
{
    ...
    struct TrackTableStyle
    {
        ...
        //--------------------------------------------------------------------------
        // Classic 2000s Track Table Effects
        //--------------------------------------------------------------------------

        bool UseGlossyHeader = false;
        float HeaderGlossIntensity = 0.0f;
        ImVec4 HeaderGlossColor = ImVec4(1.0f, 1.0f, 1.0f, 0.0f);

        bool UseHeaderGradient = false;
        ImVec4 HeaderGradientTop = ImVec4(0.280f, 0.327f, 0.371f, 1.00f);
        ImVec4 HeaderGradientBottom = ImVec4(0.280f, 0.327f, 0.371f, 1.00f);

        bool UseGlossySelection = false;
        float SelectionGlossIntensity = 0.0f;

        bool UseRoundedScrollbar = false;
        float ScrollbarGlossIntensity = 0.0f;
    };
