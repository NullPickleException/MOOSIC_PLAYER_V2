...
// ClassicRoseTheme.h
//==============================================================================
// Classic rose/deep pink theme with 3D glossy effects
// 3 base colors: Deep Rose (60%), Medium Rose (30%), Bright Pink Accent (10%)
// Palette: #2A0A1A, #4A142A, #6A1E3E, #8E24AA, #E91E63
//==============================================================================
...
namespace moosic
{
    ...
    inline Theme CreateClassicRoseTheme()
    {
        Theme t;
        ...
        // ── Deep Rose (60%) - main backgrounds (#2A0A1A, rgb(42,10,26)) ──
        const ImVec4 RoseDeep = ImVec4(0.16f, 0.04f, 0.10f, 1.00f);        // #290A19
        const ImVec4 RosePanel = ImVec4(0.18f, 0.05f, 0.12f, 1.00f);       // #2E0D1F
        const ImVec4 RoseDefault = ImVec4(0.20f, 0.06f, 0.14f, 1.00f);     // #330F24
        const ImVec4 RoseAlt = ImVec4(0.22f, 0.07f, 0.16f, 1.00f);         // #381229
        const ImVec4 RoseSurface = ImVec4(0.24f, 0.08f, 0.18f, 1.00f);     // #3D142E
        const ImVec4 RoseDarker = ImVec4(0.14f, 0.03f, 0.08f, 1.00f);      // #240814

        // ── Medium Rose (30%) - surfaces (#4A142A, rgb(74,20,42)) ──────
        const ImVec4 RoseDark = ImVec4(0.28f, 0.08f, 0.16f, 1.00f);       // #471429
        const ImVec4 RoseMid = ImVec4(0.32f, 0.10f, 0.18f, 1.00f);        // #521A2E
        const ImVec4 RoseLight = ImVec4(0.36f, 0.12f, 0.20f, 1.00f);      // #5C1F33
        const ImVec4 RoseDarkerMid = ImVec4(0.24f, 0.06f, 0.14f, 1.00f);  // #3D0F24

        // ── Bright Pink (10%) - accent (#E91E63, rgb(233,30,99)) ─────────
        const ImVec4 Accent = ImVec4(0.91f, 0.12f, 0.39f, 1.00f);          // #E91E63
        const ImVec4 AccentDark = ImVec4(0.75f, 0.08f, 0.30f, 1.00f);      // #BF144D
        const ImVec4 AccentDarker = ImVec4(0.60f, 0.05f, 0.22f, 1.00f);    // #990D38
        const ImVec4 AccentLight = ImVec4(0.95f, 0.30f, 0.50f, 1.00f);     // #F24D80
        const ImVec4 AccentVeryLight = ImVec4(0.95f, 0.30f, 0.50f, 0.50f);

        // ── Utility ──────────────────────────────────────────────────
        const ImVec4 RoseGlow = ImVec4(0.32f, 0.10f, 0.18f, 0.25f);
        const ImVec4 RoseVeryLight = ImVec4(0.32f, 0.10f, 0.18f, 0.50f);
        const ImVec4 RoseSubtle = ImVec4(0.32f, 0.10f, 0.18f, 0.10f);
        const ImVec4 SearchDropdownBg = ImVec4(0.18f, 0.05f, 0.12f, 1.00f);

        // ── Text ─────────────────────────────────────────────────────
        const ImVec4 TextBright = ImVec4(1.00f, 0.92f, 0.95f, 1.00f);
        ...
        // ── Borders ───────────────────────────────────────────────────
        const ImVec4 BorderSubtle = ImVec4(0.28f, 0.08f, 0.16f, 1.00f);

        // ── Gloss for 3D ─────────────────────────────────────────────
        const ImVec4 GlossWhite = ImVec4(1.00f, 1.00f, 1.00f, 0.50f);
        const ImVec4 GlossStrong = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
        const ImVec4 BevelShadow = ImVec4(0.12f, 0.03f, 0.08f, 0.55f);
        const ImVec4 BevelBorder = ImVec4(0.20f, 0.05f, 0.14f, 0.65f);

        //==========================================================================
        // Title Bar - Deep rose gradient
        //==========================================================================

        t.TitleBar.BackgroundColor = ImVec4(0.14f, 0.03f, 0.08f, 1.00f);
        t.TitleBar.BackgroundColorActive = ImVec4(0.14f, 0.03f, 0.08f, 1.00f);
        t.TitleBar.BackgroundColorInactive = ImVec4(0.14f, 0.03f, 0.08f, 0.85f);
        t.TitleBar.BackgroundOpacity = 1.0f;
        t.TitleBar.ShowBottomBorder = true;
        t.TitleBar.BottomBorderColor = BorderSubtle;
        t.TitleBar.ShowWindowBorder = true;
        t.TitleBar.WindowBorderColor = RoseMid;
        ...
        t.TitleBar.TitleBarGradientTop = ImVec4(0.12f, 0.02f, 0.06f, 1.00f);
        t.TitleBar.TitleBarGradientBottom = ImVec4(0.16f, 0.04f, 0.10f, 1.00f);
        ...
        t.ContentPanel.TabInactive = RoseDefault;
        t.ContentPanel.TabHovered = RoseAlt;
        t.ContentPanel.TabRounding = 4.0f;
        t.ContentPanel.TabText = TextWhite;
        t.ContentPanel.TabTextInactive = TextMuted;
        t.ContentPanel.ButtonNormal = RoseDark;
        t.ContentPanel.ButtonHovered = RoseMid;
        t.ContentPanel.ButtonActive = AccentDark;
        t.ContentPanel.ButtonRounding = 2.0f;
        t.ContentPanel.BorderColor = RoseMid;
        ...
        t.ContentPanel.TabGradientTop = RoseDefault;
        t.ContentPanel.TabGradientBottom = RoseDarker;
        ...
        t.Window.WindowBg = RosePanel;
        t.Window.ChildBg = RoseDarker;
        t.Window.WindowBorder = BorderSubtle;
        t.Window.TitleBar = RoseDefault;
        t.Window.TitleBarActive = RoseAlt;
        ...
        t.Window.ButtonNormal = RoseDark;
        t.Window.ButtonHovered = RoseMid;
        t.Window.ButtonActive = AccentDark;
        t.Window.ButtonRounding = 8.0f;
        t.Window.UseWindowGradient = true;
        t.Window.WindowGradientTop = RoseDefault;
        t.Window.WindowGradientBottom = RoseDarker;
        ...
        t.TrackTable.RowDefault = RoseDarker;
        t.TrackTable.RowDefaultAlt = RoseDefault;
        t.TrackTable.RowHovered = RoseVeryLight;
        t.TrackTable.RowClicked = AccentDarker;
        t.TrackTable.RowSelected = RoseDark;
        ...
        t.TrackTable.ScrollbarBg = RosePanel;
        t.TrackTable.ScrollbarGrab = RoseDark;
        t.TrackTable.ScrollbarGrabHovered = RoseMid;
        ...
        t.TrackTable.HeaderGradientTop = RoseMid;
        t.TrackTable.HeaderGradientBottom = RoseDark;
        ...
        t.Visualizer.BackgroundColor = RoseDarker;
        ...
        t.Visualizer.GridColor = ImVec4(RoseDark.x, RoseDark.y, RoseDark.z, 0.30f);
        t.Visualizer.BorderColor = BorderSubtle;
        t.Visualizer.PlaceholderColor = TextDim;
        t.Visualizer.UseColorRamp = true;
        t.Visualizer.SpectrumColorLow = RoseDark;
        t.Visualizer.SpectrumColorMid = RoseMid;
        t.Visualizer.SpectrumColorHigh = AccentLight;
        t.Visualizer.SpectrumColorPeak = ImVec4(1.00f, 0.45f, 0.65f, 1.00f);
        ...
        t.Visualizer.LowFreqTint = RoseDark;
        ...
        t.Visualizer.VisualizerGradientTop = RoseDefault;
        t.Visualizer.VisualizerGradientBottom = RoseDarker;
        ...
        t.AlbumArtBox.BackgroundColor = RoseDefault;
        t.AlbumArtBox.BackgroundColorHovered = RoseAlt;
        ...
        t.AlbumArtBox.InnerShadowColor = ImVec4(0.12f, 0.03f, 0.08f, 0.45f);
        ...
        t.AlbumArtLightbox.BackgroundColor = ImVec4(0.14f, 0.03f, 0.08f, 0.95f);
        t.AlbumArtLightbox.BorderColor = RoseDark;
        ...
        t.AlbumArtLightbox.LightboxGradientTop = ImVec4(0.16f, 0.04f, 0.10f, 0.95f);
        t.AlbumArtLightbox.LightboxGradientBottom = ImVec4(0.10f, 0.02f, 0.06f, 0.95f);
        ...
        t.SearchBar.borderColor = RoseMid;
        t.SearchBar.textColor = TextBright;
        t.SearchBar.highlightTextColor = AccentLight;
        t.SearchBar.rowHoverColor = RoseAlt;
        t.SearchBar.separatorColor = BorderSubtle;
        t.SearchBar.inputBgColor = RoseDefault;
        t.SearchBar.inputBorderColor = RoseMid;
        ...
        t.SearchBar.SearchGradientTop = RoseMid;
        t.SearchBar.SearchGradientBottom = RoseDefault;
        ...
        t.PlayerBar.ButtonNormal = RoseDark;
        t.PlayerBar.ButtonHovered = RoseMid;
        ...
        t.PlayerBar.PlayerBarGradientTop = RoseDefault;
        t.PlayerBar.PlayerBarGradientBottom = RoseDarker;
        ...
        t.PlayerBar.SliderTrackGradientTop = RoseDefault;
        t.PlayerBar.SliderTrackGradientBottom = RoseDarker;
        ...
        t.PlayerBar.ProgressTrackColor = RoseDarker;
        ...
        t.ContextMenu.BorderColor = RoseMid;
        ...
        t.ContextMenu.MenuGradientTop = RoseMid;
        t.ContextMenu.MenuGradientBottom = RoseDefault;
