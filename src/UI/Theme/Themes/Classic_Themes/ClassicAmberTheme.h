...
// ClassicAmberTheme.h
//==============================================================================
// Classic amber/warm gold theme with 3D glossy effects
// 3 base colors: Dark Amber (80%), Medium Amber (15%), Light Gold Accent (5%)
// Palette: #FF6F00, #FF8F00, #FFA000, #FFB300, #FFCA28
//==============================================================================
...
namespace moosic
{
    ...
    inline Theme CreateClassicAmberTheme()
    {
        Theme t;
        ...
        // ── Dark Amber (80%) - main backgrounds (#FF6F00, rgb(255,111,0)) ──
        const ImVec4 AmberDeep = ImVec4(0.80f, 0.30f, 0.00f, 1.00f);       // #CC4D00
        const ImVec4 AmberPanel = ImVec4(0.85f, 0.33f, 0.02f, 1.00f);      // #D95405
        const ImVec4 AmberDefault = ImVec4(0.90f, 0.36f, 0.04f, 1.00f);    // #E65C0A
        const ImVec4 AmberAlt = ImVec4(0.95f, 0.40f, 0.06f, 1.00f);        // #F2660F
        const ImVec4 AmberSurface = ImVec4(1.00f, 0.44f, 0.08f, 1.00f);    // #FF7014
        const ImVec4 AmberDarker = ImVec4(0.65f, 0.22f, 0.00f, 1.00f);     // #A63800

        // ── Medium Amber (15%) - surfaces (#FF8F00, rgb(255,143,0)) ──────
        const ImVec4 AmberDark = ImVec4(0.85f, 0.48f, 0.00f, 1.00f);      // #D97A00
        const ImVec4 AmberMid = ImVec4(0.95f, 0.55f, 0.02f, 1.00f);       // #F28C05
        const ImVec4 AmberLight = ImVec4(1.00f, 0.62f, 0.10f, 1.00f);     // #FF9E1A
        const ImVec4 AmberDarkerMid = ImVec4(0.75f, 0.38f, 0.00f, 1.00f); // #BF6100

        // ── Light Gold (5%) - accent (#FFCA28, rgb(255,202,40)) ──────────
        const ImVec4 Accent = ImVec4(1.00f, 0.79f, 0.16f, 1.00f);         // #FFCA28
        const ImVec4 AccentDark = ImVec4(0.85f, 0.65f, 0.10f, 1.00f);     // #D9A61A
        const ImVec4 AccentDarker = ImVec4(0.70f, 0.50f, 0.05f, 1.00f);   // #B3800D
        const ImVec4 AccentLight = ImVec4(1.00f, 0.85f, 0.35f, 1.00f);    // #FFD959
        const ImVec4 AccentVeryLight = ImVec4(1.00f, 0.85f, 0.35f, 0.50f);

        // ── Utility ──────────────────────────────────────────────────
        const ImVec4 AmberGlow = ImVec4(0.95f, 0.55f, 0.02f, 0.25f);
        const ImVec4 AmberVeryLight = ImVec4(0.95f, 0.55f, 0.02f, 0.50f);
        const ImVec4 AmberSubtle = ImVec4(0.95f, 0.55f, 0.02f, 0.10f);
        const ImVec4 SearchDropdownBg = ImVec4(0.85f, 0.33f, 0.02f, 1.00f);

        // ── Text ─────────────────────────────────────────────────────
        const ImVec4 TextBright = ImVec4(1.00f, 0.95f, 0.85f, 1.00f);
        const ImVec4 TextMuted = ImVec4(0.85f, 0.65f, 0.40f, 1.00f);
        const ImVec4 TextDim = ImVec4(0.65f, 0.45f, 0.25f, 1.00f);
        const ImVec4 TextWhite = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);

        // ── Borders ───────────────────────────────────────────────────
        const ImVec4 BorderSubtle = ImVec4(0.85f, 0.48f, 0.00f, 1.00f);

        // ── Gloss for 3D ─────────────────────────────────────────────
        const ImVec4 GlossWhite = ImVec4(1.00f, 1.00f, 1.00f, 0.50f);
        const ImVec4 GlossStrong = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
        const ImVec4 BevelShadow = ImVec4(0.40f, 0.15f, 0.00f, 0.50f);
        const ImVec4 BevelBorder = ImVec4(0.70f, 0.35f, 0.00f, 0.65f);

        //==========================================================================
        // Title Bar - Gradient from dark to slightly lighter (top→bottom)
        //==========================================================================

        t.TitleBar.BackgroundColor = ImVec4(0.65f, 0.22f, 0.00f, 1.00f);
        t.TitleBar.BackgroundColorActive = ImVec4(0.65f, 0.22f, 0.00f, 1.00f);
        t.TitleBar.BackgroundColorInactive = ImVec4(0.65f, 0.22f, 0.00f, 0.85f);
        t.TitleBar.BackgroundOpacity = 1.0f;
        t.TitleBar.ShowBottomBorder = true;
        t.TitleBar.BottomBorderColor = BorderSubtle;
        t.TitleBar.ShowWindowBorder = true;
        t.TitleBar.WindowBorderColor = AmberMid;
        ...
        t.TitleBar.TitleBarGradientTop = ImVec4(0.60f, 0.20f, 0.00f, 1.00f);
        t.TitleBar.TitleBarGradientBottom = ImVec4(0.75f, 0.28f, 0.00f, 1.00f);
        ...
        t.ContentPanel.TabInactive = AmberDefault;
        t.ContentPanel.TabHovered = AmberAlt;
        t.ContentPanel.TabRounding = 4.0f;
        t.ContentPanel.TabText = TextWhite;
        t.ContentPanel.TabTextInactive = TextMuted;
        t.ContentPanel.ButtonNormal = AmberDark;
        t.ContentPanel.ButtonHovered = AmberMid;
        t.ContentPanel.ButtonActive = AccentDark;
        t.ContentPanel.ButtonRounding = 2.0f;
        t.ContentPanel.BorderColor = AmberMid;
        ...
        t.ContentPanel.TabGradientTop = AmberDefault;
        t.ContentPanel.TabGradientBottom = AmberDarker;
        ...
        t.Window.WindowBg = AmberPanel;
        t.Window.ChildBg = AmberDarker;
        t.Window.WindowBorder = BorderSubtle;
        t.Window.TitleBar = AmberDefault;
        t.Window.TitleBarActive = AmberAlt;
        ...
        t.Window.ButtonNormal = AmberDark;
        t.Window.ButtonHovered = AmberMid;
        t.Window.ButtonActive = AccentDark;
        t.Window.ButtonRounding = 8.0f;
        t.Window.UseWindowGradient = true;
        t.Window.WindowGradientTop = AmberDefault;
        t.Window.WindowGradientBottom = AmberDarker;
        ...
        t.TrackTable.RowDefault = AmberDarker;
        t.TrackTable.RowDefaultAlt = AmberDefault;
        t.TrackTable.RowHovered = AmberVeryLight;
        t.TrackTable.RowClicked = AccentDarker;
        t.TrackTable.RowSelected = AmberDark;
        ...
        t.TrackTable.ScrollbarBg = AmberPanel;
        t.TrackTable.ScrollbarGrab = AmberDark;
        t.TrackTable.ScrollbarGrabHovered = AmberMid;
        ...
        t.TrackTable.HeaderGradientTop = AmberMid;
        t.TrackTable.HeaderGradientBottom = AmberDark;
        ...
        t.Visualizer.BackgroundColor = AmberDarker;
        ...
        t.Visualizer.SpectrumColorMid = AmberMid;
        t.Visualizer.SpectrumColorHigh = AccentLight;
        t.Visualizer.SpectrumColorPeak = ImVec4(1.00f, 0.90f, 0.40f, 1.00f);
        ...
        t.Visualizer.LowFreqTint = AmberDark;
        ...
        t.Visualizer.VisualizerGradientTop = AmberDefault;
        t.Visualizer.VisualizerGradientBottom = AmberDarker;
        ...
        t.AlbumArtBox.BackgroundColor = AmberDefault;
        t.AlbumArtBox.BackgroundColorHovered = AmberAlt;
        ...
        t.AlbumArtBox.InnerShadowColor = ImVec4(0.40f, 0.15f, 0.00f, 0.40f);
        ...
        t.AlbumArtLightbox.BackgroundColor = ImVec4(0.50f, 0.18f, 0.00f, 0.95f);
        t.AlbumArtLightbox.BorderColor = AmberDark;
        ...
        t.AlbumArtLightbox.LightboxGradientTop = ImVec4(0.60f, 0.22f, 0.00f, 0.95f);
        t.AlbumArtLightbox.LightboxGradientBottom = ImVec4(0.40f, 0.12f, 0.00f, 0.95f);
        ...
        t.SearchBar.borderColor = AmberMid;
        t.SearchBar.textColor = TextBright;
        t.SearchBar.highlightTextColor = AccentLight;
        t.SearchBar.rowHoverColor = AmberAlt;
        t.SearchBar.separatorColor = BorderSubtle;
        t.SearchBar.inputBgColor = AmberDefault;
        t.SearchBar.inputBorderColor = AmberMid;
        ...
        t.SearchBar.SearchGradientTop = AmberMid;
        t.SearchBar.SearchGradientBottom = AmberDefault;
        ...
        t.PlayerBar.ButtonNormal = AmberDark;
        t.PlayerBar.ButtonHovered = AmberMid;
        ...
        t.PlayerBar.PlayerBarGradientTop = AmberDefault;
        t.PlayerBar.PlayerBarGradientBottom = AmberDarker;
        ...
        t.PlayerBar.SliderTrackGradientTop = AmberDefault;
        t.PlayerBar.SliderTrackGradientBottom = AmberDarker;
        ...
        t.PlayerBar.ProgressTrackColor = AmberDarker;
        ...
        t.ContextMenu.BorderColor = AmberMid;
        ...
        t.ContextMenu.MenuGradientTop = AmberMid;
        t.ContextMenu.MenuGradientBottom = AmberDefault;
