//==============================================================================
// ClassicCrimsonTheme.h
//==============================================================================
// Classic crimson/cathedral red theme with 3D glossy effects
// 3 base colors: Deep Crimson (60%), Medium Crimson (30%), Bright Red Accent (10%)
// Palette: #4A0000, #6B0000, #8B0000, #A52A2A, #CC3333
//==============================================================================
...
namespace moosic
{
    ...
    inline Theme CreateClassicCrimsonTheme()
    {
        Theme t;
        ...
        // ── Deep Crimson (60%) - main backgrounds (#4A0000, rgb(74,0,0)) ──
        const ImVec4 CrimsonDeep = ImVec4(0.22f, 0.00f, 0.00f, 1.00f);       // #380000
        const ImVec4 CrimsonPanel = ImVec4(0.26f, 0.00f, 0.00f, 1.00f);      // #420000
        const ImVec4 CrimsonDefault = ImVec4(0.29f, 0.00f, 0.00f, 1.00f);    // #4A0000
        const ImVec4 CrimsonAlt = ImVec4(0.33f, 0.00f, 0.00f, 1.00f);        // #540000
        const ImVec4 CrimsonSurface = ImVec4(0.37f, 0.00f, 0.00f, 1.00f);    // #5E0000
        const ImVec4 CrimsonDarker = ImVec4(0.18f, 0.00f, 0.00f, 1.00f);     // #2E0000

        // ── Medium Crimson (30%) - surfaces (#6B0000, rgb(107,0,0)) ──────
        const ImVec4 CrimsonDark = ImVec4(0.42f, 0.00f, 0.00f, 1.00f);      // #6B0000
        const ImVec4 CrimsonMid = ImVec4(0.48f, 0.00f, 0.00f, 1.00f);       // #7A0000
        const ImVec4 CrimsonLight = ImVec4(0.55f, 0.02f, 0.02f, 1.00f);     // #8C0505
        const ImVec4 CrimsonDarkerMid = ImVec4(0.35f, 0.00f, 0.00f, 1.00f); // #5A0000

        // ── Bright Red (10%) - accent (#CC3333, rgb(204,51,51)) ──────────
        const ImVec4 Accent = ImVec4(0.80f, 0.20f, 0.20f, 1.00f);           // #CC3333
        const ImVec4 AccentDark = ImVec4(0.65f, 0.12f, 0.12f, 1.00f);       // #A61F1F
        const ImVec4 AccentDarker = ImVec4(0.50f, 0.08f, 0.08f, 1.00f);     // #801414
        const ImVec4 AccentLight = ImVec4(0.88f, 0.35f, 0.35f, 1.00f);      // #E05959
        const ImVec4 AccentVeryLight = ImVec4(0.88f, 0.35f, 0.35f, 0.50f);

        // ── Utility ──────────────────────────────────────────────────
        const ImVec4 CrimsonGlow = ImVec4(0.48f, 0.00f, 0.00f, 0.25f);
        const ImVec4 CrimsonVeryLight = ImVec4(0.48f, 0.00f, 0.00f, 0.50f);
        const ImVec4 CrimsonSubtle = ImVec4(0.48f, 0.00f, 0.00f, 0.10f);
        const ImVec4 SearchDropdownBg = ImVec4(0.26f, 0.00f, 0.00f, 1.00f);

        // ── Text ─────────────────────────────────────────────────────
        const ImVec4 TextBright = ImVec4(1.00f, 0.92f, 0.88f, 1.00f);
        const ImVec4 TextMuted = ImVec4(0.80f, 0.50f, 0.45f, 1.00f);
        const ImVec4 TextDim = ImVec4(0.60f, 0.30f, 0.28f, 1.00f);
        const ImVec4 TextWhite = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);

        // ── Borders ───────────────────────────────────────────────────
        const ImVec4 BorderSubtle = ImVec4(0.42f, 0.00f, 0.00f, 1.00f);

        // ── Gloss for 3D ─────────────────────────────────────────────
        const ImVec4 GlossWhite = ImVec4(1.00f, 1.00f, 1.00f, 0.50f);
        const ImVec4 GlossStrong = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
        const ImVec4 BevelShadow = ImVec4(0.14f, 0.00f, 0.00f, 0.55f);
        const ImVec4 BevelBorder = ImVec4(0.28f, 0.00f, 0.00f, 0.65f);

        //==========================================================================
        // Title Bar - Deep cathedral crimson gradient
        //==========================================================================

        t.TitleBar.BackgroundColor = ImVec4(0.18f, 0.00f, 0.00f, 1.00f);
        t.TitleBar.BackgroundColorActive = ImVec4(0.18f, 0.00f, 0.00f, 1.00f);
        t.TitleBar.BackgroundColorInactive = ImVec4(0.18f, 0.00f, 0.00f, 0.85f);
        t.TitleBar.BackgroundOpacity = 1.0f;
        t.TitleBar.ShowBottomBorder = true;
        t.TitleBar.BottomBorderColor = BorderSubtle;
        t.TitleBar.ShowWindowBorder = true;
        t.TitleBar.WindowBorderColor = CrimsonMid;
        ...
        t.TitleBar.TitleBarGradientTop = ImVec4(0.16f, 0.00f, 0.00f, 1.00f);
        t.TitleBar.TitleBarGradientBottom = ImVec4(0.24f, 0.00f, 0.00f, 1.00f);
        ...
        t.ContentPanel.ButtonNormal = CrimsonDark;
        t.ContentPanel.ButtonHovered = CrimsonMid;
        t.ContentPanel.ButtonActive = AccentDark;
        t.ContentPanel.ButtonRounding = 2.0f;
        t.ContentPanel.BorderColor = CrimsonMid;
        ...
        t.ContentPanel.TabGradientTop = CrimsonDefault;
        t.ContentPanel.TabGradientBottom = CrimsonDarker;
        ...
        t.Window.ChildBg = CrimsonDarker;
        ...
        t.Window.ButtonNormal = CrimsonDark;
        t.Window.ButtonHovered = CrimsonMid;
        t.Window.ButtonActive = AccentDark;
        t.Window.ButtonRounding = 8.0f;
        t.Window.UseWindowGradient = true;
        t.Window.WindowGradientTop = CrimsonDefault;
        t.Window.WindowGradientBottom = CrimsonDarker;
        ...
        t.TrackTable.HeaderBackground = CrimsonDark;
        ...
        t.TrackTable.ScrollbarGrab = CrimsonDark;
        t.TrackTable.ScrollbarGrabHovered = CrimsonMid;
        ...
        t.TrackTable.HeaderGradientTop = CrimsonMid;
        t.TrackTable.HeaderGradientBottom = CrimsonDark;
        ...
        t.Visualizer.BackgroundColor = CrimsonDarker;
        ...
        t.Visualizer.GridColor = ImVec4(CrimsonDark.x, CrimsonDark.y, CrimsonDark.z, 0.30f);
        t.Visualizer.BorderColor = BorderSubtle;
        t.Visualizer.PlaceholderColor = TextDim;
        t.Visualizer.UseColorRamp = true;
        t.Visualizer.SpectrumColorLow = CrimsonDark;
        t.Visualizer.SpectrumColorMid = CrimsonMid;
        t.Visualizer.SpectrumColorHigh = AccentLight;
        t.Visualizer.SpectrumColorPeak = ImVec4(0.95f, 0.40f, 0.40f, 1.00f);
        ...
        t.Visualizer.LowFreqTint = CrimsonDark;
        ...
        t.Visualizer.VisualizerGradientTop = CrimsonDefault;
        t.Visualizer.VisualizerGradientBottom = CrimsonDarker;
        ...
        t.AlbumArtBox.InnerShadowColor = ImVec4(0.14f, 0.00f, 0.00f, 0.45f);
        ...
        t.AlbumArtLightbox.BackgroundColor = ImVec4(0.16f, 0.00f, 0.00f, 0.95f);
        t.AlbumArtLightbox.BorderColor = CrimsonDark;
        ...
        t.AlbumArtLightbox.LightboxGradientTop = ImVec4(0.20f, 0.00f, 0.00f, 0.95f);
        t.AlbumArtLightbox.LightboxGradientBottom = ImVec4(0.12f, 0.00f, 0.00f, 0.95f);
        ...
        t.SearchBar.borderColor = CrimsonMid;
        ...
        t.SearchBar.inputBorderColor = CrimsonMid;
        ...
        t.SearchBar.SearchGradientTop = CrimsonMid;
        t.SearchBar.SearchGradientBottom = CrimsonDefault;
        ...
        t.PlayerBar.ButtonNormal = CrimsonDark;
        t.PlayerBar.ButtonHovered = CrimsonMid;
        ...
        t.PlayerBar.PlayerBarGradientTop = CrimsonDefault;
        t.PlayerBar.PlayerBarGradientBottom = CrimsonDarker;
        ...
        t.PlayerBar.SliderTrackGradientTop = CrimsonDefault;
        t.PlayerBar.SliderTrackGradientBottom = CrimsonDarker;
        ...
        t.PlayerBar.ProgressTrackColor = CrimsonDarker;
        ...
        t.ContextMenu.BorderColor = CrimsonMid;
        ...
        t.ContextMenu.MenuGradientTop = CrimsonMid;
        t.ContextMenu.MenuGradientBottom = CrimsonDefault;
