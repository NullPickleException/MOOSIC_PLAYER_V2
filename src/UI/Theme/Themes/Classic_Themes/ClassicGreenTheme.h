...
// ClassicGreenTheme.h
//==============================================================================
// Clean green theme with 3D glossy effects
// 3 base colors: Forest Green, Lime Green, Yellow Accent
// Palette: #266210, #90B800, #E1E100, rgb(6,59,0), rgb(38,98,16)
//==============================================================================
...
namespace moosic
{
    ...
    inline Theme CreateClassicGreenTheme()
    {
        Theme t;

        //==========================================================================
        // Base palette (RGB → normalized) - 3 distinct green tones
        //==========================================================================

        // ── Forest Green (60%) - main backgrounds (#266210, rgb(38,98,16)) ──
        const ImVec4 ForestDeep = ImVec4(0.10f, 0.28f, 0.04f, 1.00f);    // #1A4710
        const ImVec4 ForestPanel = ImVec4(0.12f, 0.32f, 0.06f, 1.00f);   // #1F520F
        const ImVec4 ForestDefault = ImVec4(0.15f, 0.38f, 0.06f, 1.00f); // #266210
        const ImVec4 ForestAlt = ImVec4(0.18f, 0.42f, 0.08f, 1.00f);     // #2E6B14
        const ImVec4 ForestSurface = ImVec4(0.20f, 0.46f, 0.10f, 1.00f); // #337519

        // ── Lime Green (30%) - surfaces (#90B800, rgb(144,184,0)) ──────
        const ImVec4 LimeDark = ImVec4(0.42f, 0.62f, 0.00f, 1.00f);   // #6B9E00
        const ImVec4 LimeMid = ImVec4(0.56f, 0.72f, 0.00f, 1.00f);    // #90B800
        const ImVec4 LimeLight = ImVec4(0.68f, 0.82f, 0.15f, 1.00f);  // #ADD126
        const ImVec4 LimeDarker = ImVec4(0.32f, 0.50f, 0.00f, 1.00f); // #528000

        // ── Yellow (10%) - accent (#E1E100, rgb(225,225,0)) ────────────
        const ImVec4 Accent = ImVec4(0.88f, 0.88f, 0.00f, 1.00f);       // #E1E100
        const ImVec4 AccentDark = ImVec4(0.70f, 0.70f, 0.00f, 1.00f);   // #B3B300
        const ImVec4 AccentDarker = ImVec4(0.50f, 0.50f, 0.00f, 1.00f); // #808000
        const ImVec4 AccentLight = ImVec4(0.95f, 0.95f, 0.20f, 1.00f);  // #F2F233
        const ImVec4 AccentVeryLight = ImVec4(0.95f, 0.95f, 0.20f, 0.50f);

        // ── Utility ──────────────────────────────────────────────────
        const ImVec4 GreenGlow = ImVec4(0.56f, 0.72f, 0.00f, 0.25f);
        const ImVec4 GreenVeryLight = ImVec4(0.56f, 0.72f, 0.00f, 0.50f);
        const ImVec4 GreenSubtle = ImVec4(0.56f, 0.72f, 0.00f, 0.10f);
        const ImVec4 SearchDropdownBg = ImVec4(0.18f, 0.42f, 0.08f, 1.00f);

        // ── Text ─────────────────────────────────────────────────────
        const ImVec4 TextBright = ImVec4(0.95f, 0.97f, 0.90f, 1.00f);
        const ImVec4 TextMuted = ImVec4(0.60f, 0.72f, 0.45f, 1.00f);
        const ImVec4 TextDim = ImVec4(0.35f, 0.50f, 0.25f, 1.00f);
        const ImVec4 TextWhite = ImVec4(0.99f, 0.99f, 0.95f, 1.00f);

        // ── Borders ───────────────────────────────────────────────────
        const ImVec4 BorderSubtle = ImVec4(0.30f, 0.55f, 0.10f, 1.00f);

        // ── Gloss for 3D ─────────────────────────────────────────────
        const ImVec4 GlossWhite = ImVec4(1.00f, 1.00f, 1.00f, 0.50f);
        const ImVec4 GlossStrong = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
        const ImVec4 BevelShadow = ImVec4(0.02f, 0.15f, 0.00f, 0.50f);
        const ImVec4 BevelBorder = ImVec4(0.20f, 0.48f, 0.05f, 0.65f);

        //==========================================================================
        // Title Bar
        //==========================================================================

        t.TitleBar.BackgroundColor = ImVec4(0.06f, 0.20f, 0.02f, 1.00f);
        t.TitleBar.BackgroundColorActive = ImVec4(0.06f, 0.20f, 0.02f, 1.00f);
        t.TitleBar.BackgroundColorInactive = ImVec4(0.06f, 0.20f, 0.02f, 0.85f);
        t.TitleBar.BackgroundOpacity = 1.0f;
        t.TitleBar.ShowBottomBorder = true;
        t.TitleBar.BottomBorderColor = BorderSubtle;
        t.TitleBar.ShowWindowBorder = true;
        t.TitleBar.WindowBorderColor = LimeMid;
        ...
        t.TitleBar.TitleBarGradientTop = ImVec4(0.10f, 0.26f, 0.04f, 1.00f);
        t.TitleBar.TitleBarGradientBottom = ImVec4(0.04f, 0.14f, 0.00f, 1.00f);
        ...
        t.ContentPanel.TabInactive = ForestDefault;
        t.ContentPanel.TabHovered = ForestAlt;
        t.ContentPanel.TabRounding = 4.0f;
        t.ContentPanel.TabText = TextWhite;
        t.ContentPanel.TabTextInactive = TextMuted;
        t.ContentPanel.ButtonNormal = LimeDark;
        t.ContentPanel.ButtonHovered = LimeMid;
        t.ContentPanel.ButtonActive = AccentDark;
        t.ContentPanel.ButtonRounding = 2.0f;
        t.ContentPanel.BorderColor = LimeMid;
        ...
        t.ContentPanel.TabGradientTop = ForestDefault;
        t.ContentPanel.TabGradientBottom = LimeDark;
        ...
        t.Window.WindowBg = ForestPanel;
        t.Window.ChildBg = ForestDeep;
        t.Window.WindowBorder = BorderSubtle;
        t.Window.TitleBar = ForestDefault;
        t.Window.TitleBarActive = ForestAlt;
        ...
        t.Window.ButtonNormal = LimeDark;
        t.Window.ButtonHovered = LimeMid;
        t.Window.ButtonActive = AccentDark;
        t.Window.ButtonRounding = 8.0f;
        t.Window.UseWindowGradient = true;
        t.Window.WindowGradientTop = ForestDefault;
        t.Window.WindowGradientBottom = ForestDeep;
        ...
        t.TrackTable.RowDefault = ForestDeep;
        t.TrackTable.RowDefaultAlt = ForestDefault;
        t.TrackTable.RowHovered = GreenVeryLight;
        t.TrackTable.RowClicked = AccentDarker;
        t.TrackTable.RowSelected = LimeDark;
        ...
        t.TrackTable.ScrollbarBg = ForestPanel;
        t.TrackTable.ScrollbarGrab = LimeDark;
        t.TrackTable.ScrollbarGrabHovered = LimeMid;
        ...
        t.TrackTable.HeaderGradientTop = LimeMid;
        t.TrackTable.HeaderGradientBottom = LimeDark;
        ...
        t.Visualizer.BackgroundColor = ForestDeep;
        t.Visualizer.WaveformColor = Accent;
        t.Visualizer.WaveformFillColor = ImVec4(Accent.x, Accent.y, Accent.z, 0.15f);
        t.Visualizer.GridColor = ImVec4(LimeDark.x, LimeDark.y, LimeDark.z, 0.30f);
        t.Visualizer.BorderColor = BorderSubtle;
        t.Visualizer.PlaceholderColor = TextDim;
        t.Visualizer.UseColorRamp = true;
        t.Visualizer.SpectrumColorLow = LimeDark;
        t.Visualizer.SpectrumColorMid = LimeMid;
        t.Visualizer.SpectrumColorHigh = AccentLight;
        t.Visualizer.SpectrumColorPeak = ImVec4(0.95f, 0.95f, 0.40f, 1.00f);
        ...
        t.Visualizer.LowFreqTint = LimeDark;
        ...
        t.Visualizer.VisualizerGradientTop = ForestDefault;
        t.Visualizer.VisualizerGradientBottom = LimeDark;
        ...
        t.AlbumArtBox.BackgroundColor = ForestDefault;
        t.AlbumArtBox.BackgroundColorHovered = ForestAlt;
        ...
        t.AlbumArtBox.InnerShadowColor = ImVec4(0.02f, 0.15f, 0.00f, 0.40f);
        ...
        t.AlbumArtLightbox.BackgroundColor = ImVec4(0.04f, 0.18f, 0.02f, 0.95f);
        t.AlbumArtLightbox.BorderColor = LimeDark;
        ...
        t.AlbumArtLightbox.LightboxGradientTop = ImVec4(0.08f, 0.24f, 0.04f, 0.95f);
        t.AlbumArtLightbox.LightboxGradientBottom = ImVec4(0.02f, 0.10f, 0.00f, 0.95f);
        ...
        t.SearchBar.borderColor = LimeMid;
        t.SearchBar.textColor = TextBright;
        t.SearchBar.highlightTextColor = Accent;
        t.SearchBar.rowHoverColor = ForestAlt;
        t.SearchBar.separatorColor = BorderSubtle;
        t.SearchBar.inputBgColor = ForestDefault;
        t.SearchBar.inputBorderColor = LimeMid;
        ...
        t.SearchBar.SearchGradientTop = LimeMid;
        t.SearchBar.SearchGradientBottom = ForestDefault;
        ...
        t.PlayerBar.ButtonNormal = LimeDark;
        t.PlayerBar.ButtonHovered = LimeMid;
        t.PlayerBar.ButtonActive = AccentDark;
        t.PlayerBar.ButtonPrimary = Accent;
        t.PlayerBar.ButtonPrimaryHovered = AccentLight;
        ...
        t.PlayerBar.PlayerBarGradientTop = ForestDefault;
        t.PlayerBar.PlayerBarGradientBottom = LimeDark;
        ...
        t.PlayerBar.SliderTrackGradientTop = ForestDefault;
        t.PlayerBar.SliderTrackGradientBottom = LimeDark;
        ...
        t.PlayerBar.ProgressTrackColor = ForestDeep;
        ...
        t.ContextMenu.BorderColor = LimeMid;
        ...
        t.ContextMenu.MenuGradientTop = LimeMid;
        t.ContextMenu.MenuGradientBottom = ForestDefault;
