...
namespace moosic
{
    ...
    inline Theme CreateDarkOrangeTheme()
    {
        Theme t;
        ...
        const ImVec4 Orange = ImVec4(0.902f, 0.580f, 0.200f, 1.00f);       // 230,148,51
        const ImVec4 OrangeDark = ImVec4(0.678f, 0.435f, 0.149f, 1.00f);   // 173,111,38
        const ImVec4 OrangeDarker = ImVec4(0.510f, 0.329f, 0.114f, 1.00f); // 130,84,29
        const ImVec4 OrangeLight = ImVec4(0.957f, 0.702f, 0.400f, 1.00f);  // 244,179,102
        const ImVec4 OrangeVeryLight = ImVec4(0.957f, 0.702f, 0.400f, 0.5f);
        const ImVec4 OrangeGlow = ImVec4(0.902f, 0.580f, 0.200f, 0.20f);
        const ImVec4 OrangeSubtle = ImVec4(0.902f, 0.580f, 0.200f, 0.10f);
        ...
        t.TitleBar.WindowBorderColor = OrangeLight;
        t.TitleBar.ShowAccentLine = false;
        t.TitleBar.AccentLineColor = Orange;
        ...
        t.ContentPanel.TabActive = Orange;
        ...
        t.ContentPanel.ButtonHovered = Orange;
        t.ContentPanel.ButtonActive = OrangeDark;
        t.ContentPanel.ButtonRounding = 2.0f;
        t.ContentPanel.BorderColor = OrangeLight;
        ...
        t.Window.BrandText = Orange;
        t.Window.ButtonNormal = GreyDark;
        t.Window.ButtonHovered = Orange;
        t.Window.ButtonActive = OrangeDark;
        t.Window.ProgressBar = Orange;
        t.Window.PlayingHighlight = OrangeGlow;
        ...
        t.TrackTable.HeaderActive = Orange;
        ...
        t.TrackTable.RowHovered = ImVec4(Orange.x, Orange.y, Orange.z, 0.25f);
        t.TrackTable.RowClicked = ImVec4(Orange.x, Orange.y, Orange.z, 0.45f);
        t.TrackTable.RowSelected = OrangeLight;
        t.TrackTable.RowPlaying = Orange;
        ...
        t.TrackTable.ScrollbarGrabActive = Orange;
        ...
        t.Visualizer.WaveformColor = Orange;
        t.Visualizer.WaveformFillColor = ImVec4(Orange.x, Orange.y, Orange.z, 0.10f);
        ...
        t.Visualizer.SpectrumColorLow = Orange;
        t.Visualizer.SpectrumColorMid = OrangeLight;
        t.Visualizer.SpectrumColorHigh = ImVec4(1.00f, 0.75f, 0.35f, 1.00f);
        ...
        t.AlbumArtBox.BorderColorHovered = Orange;
        t.AlbumArtBox.BorderColorClicked = OrangeLight;
        ...
        t.AlbumArtBox.HoverOverlayColor = ImVec4(Orange.x, Orange.y, Orange.z, 0.08f);
        t.AlbumArtBox.ClickOverlayColor = ImVec4(Orange.x, Orange.y, Orange.z, 0.18f);
        ...
        t.AlbumArtLightbox.CloseButtonHovered = Orange;
        ...
        t.SearchBar.highlightTextColor = Orange;
        ...
        t.PlayerBar.ButtonNormal = Orange;
        t.PlayerBar.ButtonHovered = OrangeLight;
        t.PlayerBar.ButtonActive = OrangeDark;
        t.PlayerBar.ButtonPrimary = Orange;
        t.PlayerBar.ButtonPrimaryHovered = OrangeLight;
        t.PlayerBar.ButtonPrimaryActive = OrangeDark;
        t.PlayerBar.SliderTrack = GreyDarker;
        t.PlayerBar.SliderGrab = Orange;
        t.PlayerBar.SliderGrabActive = OrangeLight;
