...
// LightOrangeTheme.h
//==============================================================================
// Warm, eye-friendly light theme with orange accent
//==============================================================================
...
namespace moosic
{
    ...
    inline Theme CreateLightOrangeTheme()
    {
        Theme t;
        ...
        const ImVec4 OrangeGlow = ImVec4(0.902f, 0.580f, 0.200f, 0.10f);
        const ImVec4 OrangeSubtle = ImVec4(0.902f, 0.580f, 0.200f, 0.06f);
        ...
        t.TitleBar.WindowBorderColor = Orange;
        ...
        t.TrackTable.RowHovered = ImVec4(Orange.x, Orange.y, Orange.z, 0.20f);
        t.TrackTable.RowClicked = ImVec4(Orange.x, Orange.y, Orange.z, 0.35f);
        t.TrackTable.RowSelected = OrangeLight;
        t.TrackTable.RowPlaying = OrangeLight;
        ...
        t.Visualizer.WaveformFillColor = ImVec4(Orange.x, Orange.y, Orange.z, 0.06f);
        ...
        t.Visualizer.SpectrumColorLow = ImVec4(0.800f, 0.600f, 0.380f, 1.00f);
        t.Visualizer.SpectrumColorMid = Orange;
        t.Visualizer.SpectrumColorHigh = ImVec4(0.650f, 0.380f, 0.100f, 1.00f);
        ...
        t.AlbumArtBox.HoverOverlayColor = ImVec4(Orange.x, Orange.y, Orange.z, 0.05f);
        t.AlbumArtBox.ClickOverlayColor = ImVec4(Orange.x, Orange.y, Orange.z, 0.12f);
        ...
        t.PlayerBar.ButtonHovered = Orange;
        ...
        t.ContextMenu.BorderColor = Orange;
